...
//
    ...
    $body .= "<div>\n";
    $body .= "<ul>\n";
    $body .= $page->bodyBuilder->liAnchor("#top10", "Top 10 des questions des recruteurs expliqu&eacute;es");
    $body .= $page->bodyBuilder->liAnchor("#weakness", "What is your greatest weakness?");
    $body .= $page->bodyBuilder->liAnchor("#sheepie", "Better answers to sheepie questions");
    $body .= $page->bodyBuilder->liAnchor("#liste", "Liste de questions");
    $body .= $page->bodyBuilder->liAnchor("#list", "List of questions");
    $body .= $page->bodyBuilder->liAnchor("#body", "Body-language mistakes");
    $body .= "</ul>\n";
    $body .= "</div>\n";
//
...
//
    ...
    $body .= $page->bodyBuilder->anchor(
        "https://www.linkedin.com/today/post/article/20130709020109-52594-answering-the-question-what-s-your-greatest-weakness?trk=hb_ntf_MEGAPHONE_ARTICLE_LIKE?trk=object-title",
        "this LinkedIn page"
    );
    $body .= "</p>\n";
...
//
    ...
    $body .= "<p>";
    $body .= $page->bodyBuilder->anchor(
        "https://www.linkedin.com/pulse/article/20140913052148-52594-smart-answers-to-stupid-interview-questions?trk=tod-home-art-list-large_0",
        "From this"
    );
    $body .= "</p>\n";
...
//
    ...
    $body .= "<p>Sources:</p>\n";
    $body .= "<ul>\n";
    $body .= $page->bodyBuilder->liAnchor("http://www.linkedin.com/today/post/article/20130123154152-201849-32-killer-interview-questions", "LinkedIn");
    $body .= $page->bodyBuilder->liAnchor("http://www.inc.com/lou-adler/best-interview-question-ever.html?cid=sf01001", "inc.com");
    $body .= $page->bodyBuilder->liAnchor("https://www.linkedin.com/today/post/article/20140807094555-20017018-13-ceos-share-their-favorite-job-interview-questions?trk=tod-home-art-list-large_0", "another LinkedIn");
    $body .= $page->bodyBuilder->liAnchor("https://www.linkedin.com/today/post/article/20140813123349-36714090-the-2nd-most-important-interview-question?trk=tod-home-art-list-small_2", "another another LI");
    ...
    //
        ...
        $body .= "<p>";
        $body .= $page->bodyBuilder->anchor(
            "https://www.linkedin.com/today/post/article/20140804100911-64875646-the-most-unusual-interview-questions-and-how-to-answer-them?trk=tod-home-art-list-small_2",
            "Source"
        );
        $body .= "</p>\n";
    ...
    //
        ...
        $body .= "<p>";
        $body .= $page->bodyBuilder->anchor(
            "http://www.careerealism.com/most-common-interview-questions/#!Z6W0u",
            "Source"
        );
        $body .= "</p>\n";
        // 1
