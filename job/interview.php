...
//(generally lower), it is time to negotiate speaking about bonus or holidays.
    ...
    $body .= "</ul>\n";
    $body .= $page->bodyBuilder->anchor("https://www.linkedin.com/pulse/article/20141124074017-64875646-job-interview-the-5-questions-you-must-ask?trk=tod-home-art-list-small_3", "5 questions to ask");
    $body .= "<ul>\n";
    ...
    $body .= "</div>\n";
    $body .= "<div>\n";
    $body .= $page->bodyBuilder->anchor("https://www.linkedin.com/pulse/1-most-impressive-job-interview-question-ask-dave-kerpen", "The 1 Most Impressive Job Interview Question to Ask");
    $body .= "<ul>\n";
...
$body .= "<div>";
$body .= $page->bodyBuilder->anchor("http://www.kaspersky.com/recruitment-scheme/job-interview", "Prepare for an interview");
$body .= "</div>\n";
