...
// Set languages
$page->logopedist->setAvailLangs(array("francais", "english"));  // This page is both french and english
$page->logopedist->changeSessionLang();  // check if got anything in GET
...
if($page->logopedist->checkSessionLang("francais")) {
    // french
        ...
        $contents .= "<div>\n";
        $contents .= "<ul>\n";
        $contents .= "<li>" . $page->bodyBuilder->anchor($albumURL, "Mes photos") . " et sur $ig</li>\n";
    ...
    // english
        ...
        $contents .= "<div>\n";
        $contents .= "<ul>\n";
        $contents .= "<li>" . $page->bodyBuilder->anchor($albumURL, "My pictures") . " and on $ig</li>\n";
