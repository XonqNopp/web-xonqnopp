...
$body .= $page->waitress->rowOpen();
    ...
    //
        ...
        $body .= "Misc:\n";
        $body .= "<ul>\n";
        $body .= $page->bodyBuilder->liAnchor("http://www.sust.admin.ch/fr/index.html", "SESE/SUST");

        $body .= "<li>\n";
        $body .= $page->bodyBuilder->anchor("http://www.bazl.admin.ch/index.html?lang=fr", "OFAC/BAZL");
        $body .= "&nbsp;-&nbsp;\n";
        $body .= $page->bodyBuilder->anchor("https://www.bazl.admin.ch/bazl/fr/home/experts/formation-et-licences/pilotes/formulaires.html", "Formulaires AESA, avions &agrave; moteur, 60.521 SEP TMG revaildation EASA");
        $body .= "</li>\n";
